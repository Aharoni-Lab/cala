...
class TestTransformerMeta:
    def test_signature_extraction_basic(self):
    ...
    def test_signature_extraction_optional(self):
    ...
    def test_signature_extraction_complex(self):
    ...
    def test_signature_extraction_no_types(self):
    ...
    def test_private_method_signature(self):
    ...
    def test_method_call_preservation(self):
