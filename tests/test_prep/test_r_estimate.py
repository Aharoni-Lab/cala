...
@pytest.mark.xfail
def test_size_estim(four_separate_cells):
    kwargs = {
        "min_sigma": 1,
        "max_sigma": 10,
        "num_sigma": 10,
    ...
    expected = four_separate_cells.cell_radii[0] - 1
    ...
    for center in node.centers_:
        ...
        assert Position(width=width, height=height) in four_separate_cells.cell_positions
