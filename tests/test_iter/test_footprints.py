...
from cala.nodes.init.common.traces import TracesInitializer, TracesInitializerParams
...
from cala.nodes.iter.footprints import FootprintsUpdater, FootprintsUpdaterParams
...
class TestFootprintUpdater:
    ...
    def test_imperfect_condition(
        self, plotter: Plotter, mini_footprints: xr.DataArray, mini_denoised: xr.DataArray
    ) -> None:
        # Add noise to stats
